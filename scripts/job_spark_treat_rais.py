...
rais = (
    rais.withColumnRenamed("Bairros SP", "bairros_sp")
...
rais = (
    rais.withColumn("mes_desligamento", f.col("mes_desligamento").cast("int"))
    .withColumn(
        "vl_remun_dezembro_nom",
        f.regexp_replace("vl_remun_dezembro_nom", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_remun_dezembro_sm",
        f.regexp_replace("vl_remun_dezembro_sm", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_remun_media_nom",
        f.regexp_replace("vl_remun_media_nom", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_remun_media_sm",
        f.regexp_replace("vl_remun_media_sm", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_rem_janeiro_sc",
        f.regexp_replace("vl_rem_janeiro_sc", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_rem_fevereiro_sc",
        f.regexp_replace("vl_rem_fevereiro_sc", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_rem_marco_sc", f.regexp_replace("vl_rem_marco_sc", ",", ".").cast("double")
    )
    .withColumn(
        "vl_rem_abril_sc", f.regexp_replace("vl_rem_abril_sc", ",", ".").cast("double")
    )
    .withColumn(
        "vl_rem_maio_sc", f.regexp_replace("vl_rem_maio_sc", ",", ".").cast("double")
    )
    .withColumn(
        "vl_rem_junho_sc", f.regexp_replace("vl_rem_junho_sc", ",", ".").cast("double")
    )
    .withColumn(
        "vl_rem_julho_sc", f.regexp_replace("vl_rem_julho_sc", ",", ".").cast("double")
    )
    .withColumn(
        "vl_rem_agosto_sc",
        f.regexp_replace("vl_rem_agosto_sc", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_rem_setembro_sc",
        f.regexp_replace("vl_rem_setembro_sc", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_rem_outubro_sc",
        f.regexp_replace("vl_rem_outubro_sc", ",", ".").cast("double"),
    )
    .withColumn(
        "vl_rem_novembro_sc",
        f.regexp_replace("vl_rem_novembro_sc", ",", ".").cast("double"),
    )
)
